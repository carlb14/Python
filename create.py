...
font = Font(color='FFFFFF', bold=True, name="Ariel",size="10")  # White text color
...
SaveAs = input('Enter what name of the file e.g "sample.extension name" (File extensions available = ".xlsx, .lsm, xltx, .xltm"): ')
